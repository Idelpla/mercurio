    ...
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row) {
                if (row.is('TR')) {
                    ...
                    row.find('.form-check').append('<a class="' + options.deleteCssClass +'" href="javascript:void(0)">' + options.deleteText + '</a>');
        ...
        if ($$.length) {
            ...
            if ($$.attr('tagName') == 'TR') {
                ...
                $$.filter(':last').after('<tr><td class="text-center"><a class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a></td></tr>');
