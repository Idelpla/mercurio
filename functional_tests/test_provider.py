...
class ProviderTest(FunctionalTest):
    ...
    def test_new_statement(self):
        ...
        self.browser.find_element_by_name('attachments-0-attachment').send_keys(os.path.join(SCRIPT_DIR, 'attachments/dummy_attachment.txt'))
        self.browser.find_element_by_link_text('Add Other').click()
        self.browser.find_element_by_name('attachments-1-attachment').send_keys(os.path.join(SCRIPT_DIR, 'attachments/dummy_attachment_two.txt'))
        ...
        self.assertIn('dummy_attachment.txt', self.browser.find_element_by_tag_name('body').text)
    ...
    def test_cant_see_other_owner_statement(self):
        ...
        self.assertIn('403 Forbidden'.format(other_user_statement.pk), self.browser.find_element_by_tag_name('body').text)
